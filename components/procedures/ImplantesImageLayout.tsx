...
interface ImplantesImageLayoutProps {
    images: ProcedureImages[];
}

export default function ImplantesImageLayout ({images}: ImplantesImageLayoutProps) {
    return (
        <div>
            {images.map((item, key) => (
                            ...
                            {item.imgs.map((img, key2) => (
                                <div key={key2} className="flex flex-col items-center">
                                    ...
                                    <div
                                        ...
                                        w-[70%] h-auto sm:w-[210px] sm:h-40 md:w-[320px] md:h-60 lg:w-[370px] lg:h-70 
                                        overflow-hidden"
                                    >
                                        <Image
