...
interface HarmonizacaoImageLayoutProps {
    images: ProcedureImages[];
}

export default function HarmonizacaoImageLayout ({images}: HarmonizacaoImageLayoutProps) {
    return (
        <div>
            {images.map((item, key) => (
                <div className="mb-6 md:mb-8" key={key}>
                    ...
                    <div className="space-y-4 md:space-y-6">
                        <div className="grid sm:grid-cols-2 gap-3 md:gap-4 scroll-reveal">
                            {item.imgs.map((img, key2) => (
                                <div key={key2} className="flex flex-col items-center">
                                    ...
                                    <div
                                        ...
                                        w-[70%] h-auto sm:w-[200px] sm:h-50  md:w-[250px] md:h-60  lg:w-[350px] lg:h-70 
                                        overflow-hidden"
                                    >
                                        <Image
