...
interface PlasticaImageLayoutProps {
    images: ProcedureImages[];
}

export default function PlasticaImageLayout ({images}: PlasticaImageLayoutProps) {
    return (
                            ...
                            {item.imgs.map((img, key2) => (
                                <div key={key2} className="flex flex-col items-center">
                                    ...
                                    <div
                                        ...
                                        w-[80%] h-30 sm:w-[280px] sm:h-20 md:w-[330px] md:h-30 lg:w-[450px] lg:h-40
                                        overflow-hidden"
                                    >
                                        <Image
