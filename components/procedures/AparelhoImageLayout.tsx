...
interface AparelhoImageLayoutProps {
    images: ProcedureImages[];
}

export default function AparelhoImageLayout ({images}: AparelhoImageLayoutProps) {
    return (
        <div>
            {images.map((item, key) => (
                <div className="mb-6 md:mb-8" key={key}>
                    ...
                    <div className="space-y-4 md:space-y-6">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 scroll-reveal">
                            {item.imgs.map((img, key2) => (
                                <div key={key2} className="flex flex-col items-center">
                                    ...
                                    <div
                                        ...
                                        w-[70%] h-30 sm:w-full sm:h-30 md:h-50 lg:h-30 
                                        overflow-hidden"
                                    >
                                        <Image
